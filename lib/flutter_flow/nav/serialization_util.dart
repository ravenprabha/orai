  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PItemsRow:
            return PItemsRow(data);
          case PAttributesRow:
            return PAttributesRow(data);
          case PCategoryRow:
            return PCategoryRow(data);
          case AConvosRow:
            return AConvosRow(data);
          case AChatsRow:
            return AChatsRow(data);
          case POrderitemsRow:
            return POrderitemsRow(data);
          case ARow:
            return ARow(data);
          case PProductsRow:
            return PProductsRow(data);
          case POrdersRow:
            return POrdersRow(data);
          case PTablesRow:
            return PTablesRow(data);
          case PImglibraryRow:
            return PImglibraryRow(data);
          case PStoreRow:
            return PStoreRow(data);
          case ParCmsRow:
            return ParCmsRow(data);
          case ParRow:
            return ParRow(data);
          default:
            return null;
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case AllTasksRow:
            return AllTasksRow(data);
          case GetAllItemsRow:
            return GetAllItemsRow(data);
          case GetItemChangesRow:
            return GetItemChangesRow(data);
          default:
            return null;
        }
