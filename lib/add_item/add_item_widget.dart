                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 20.0, 8.0, 0.0),
                          child: FutureBuilder<List<PCategoryRow>>(
                            future: FFAppState().category(
                              requestFn: () => PCategoryTable().queryRows(
                                queryFn: (q) => q,
                              ),
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<PCategoryRow> dropDownPCategoryRowList =
                                  snapshot.data!;
                              return FlutterFlowDropDown<String>(
                                controller: _model.dropDownValueController ??=
                                    FormFieldController<String>(null),
                                options: dropDownPCategoryRowList
                                    .map((e) => e.name)
                                    .withoutNulls
                                    .toList(),
                                onChanged: (val) =>
