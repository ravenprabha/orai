                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelStyle: FlutterFlowTheme.of(context).bodyLarge,
                            hintText: widget.taskRef?.details,
                            hintStyle: FlutterFlowTheme.of(context).labelLarge,
                            enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color: FlutterFlowTheme.of(context).alternate,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await SQLiteManager.instance.updateTasks(
                              title: _model.taskController.text,
                              details: _model.detailsController.text,
                              endDate: _model.datePicked!.secondsSinceEpoch,
                              taskStatus: !_model.switchValue! ? 1 : 0,
                              id: widget.taskRef!.id,
                            );
